...
const Slot1 = () => {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await fetch(
        `https://ytbackend-jftb.onrender.com/api/v1/notification/by-slot/1`
      );
  ...
  const requestVideos = async () => {
    try {
      await axios
        .put(
          `https://ytbackend-jftb.onrender.com/api/v1/notification/request/1`
        )
        .then(() => {
          setOpen(true);
  ...
  const clearVideos = async () => {
    try {
      await axios
        .put(
          `https://ytbackend-jftb.onrender.com/api/v1/notification/update-by-slot?slotId=1`
        )
        .then(() => {
          setOpen(true);
