...
const Slot4 = () => {
  ...
  const fetchNotifications = async () => {
    try {
      const response = await fetch(
        `https://ytbackend-jftb.onrender.com/api/v1/notification/by-slot/4`
      );
  ...
  const requestVideos = async () => {
    try {
      await fetch(
        `https://ytbackend-jftb.onrender.com/api/v1/notification/request/4`,
        {
          method: "PUT",
        }
      );
  ...
  const clearVideos = async () => {
    try {
      await fetch(
        `https://ytbackend-jftb.onrender.com/api/v1/notification/update-by-slot?slotId=4`,
        {
          method: "PUT",
        }
      );
